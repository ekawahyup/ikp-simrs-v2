...
export async function POST(req: Request) {
  try {
    ...
    // Pemrosesan Real AI menggunakan Gemini (Menggunakan gemini-flash-latest agar selalu kompatibel dan cepat)
    ...
    const prompt = `
      ...
      Instruksi format balasan (Berikan HANYA dalam format JSON valid tanpa format markdown \`\`\`json):
      {
        ...
        "probabilitas": 3, // Nilai integer 1-5 berdasarkan kemungkinan terjadi berulang
        "dampak": 3, // Nilai integer 1-5 berdasarkan tingkat keparahan pada pasien
